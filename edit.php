    ...
    <body>
        ...
        <form method="post" action="update.php">
            ...
            <select name="category">
                ...
                <option value="1" <?php if($result['category'] === "1") echo "slected" ?>>和食</option>
                <option value="2" <?php if($result['category'] === "2") echo "slected" ?>>中華</option>
                <option value="3" <?php if($result['category'] === "3") echo "slected" ?>>洋食</option>
            </select>
            <br>
             難易度：
